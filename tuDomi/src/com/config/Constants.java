...
public class Constants {
	...
	public static String FRAGMENT_RESTAURANTES = "FRAGMENT_RESTAURANTES";
	public static String FRAGMENT_SPLASH = "FRAGMENT_SPLASH";
	public static String FRAGMENT_GRIDS = "FRAGMENT_GRIDS";
	public static String FRAGMENT_PEDIDO = "FRAGMENT_PEDIDO";
	
	public static String URL_PATH = "http://tudomicilio.liceogalois.com/restaurante/";
	public static String URL_PATH_PHOTO = "http://tudomicilio.liceogalois.com/utiles/imagenes/fotos/";
	public static String URL_PATH_PHOTO_RESTAURANTE = "http://tudomicilio.liceogalois.com/utiles/imagenes/restaurantes/";
	public static String URL_PATH_PHOTO_MARCADOR = "http://tudomicilio.liceogalois.com/utiles/imagenes/marcadores/";
}
