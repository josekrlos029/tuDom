...
@SuppressLint("ResourceAsColor") public class MGSegmentControl extends LinearLayout implements OnClickListener{
	...
	public void setSegmentCreation(int[] selectedResId, 
			int[] unselectedResId, int[] titleResId, Typeface tipoLetra ) throws Exception {
